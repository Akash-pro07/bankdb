...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welcome to EasyBank</h4>
  <p>Welcome to EasyBank, your trusted partner in financial empowerment!</p>
  ...
  <?php 
      ...
      if ($array->num_rows > 0)
      {
        ...
        // {
          echo "Welcome to EasyBank! Stay tuned for important updates here.";
        // }
      }
      else
...
<div class="col">
    <div class="row" style="padding: 22px;padding-top: 0">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/bank-4541449.jpg" alt="Card image cap" style="max-height: 155px;min-height: 155px">
        <div class="card-body">
    ...
    <div class="row" style="padding: 22px">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/notif.jpg" style="max-height: 155px;min-height: 155px" alt="Card image cap">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/cont.jpg" alt="Card image cap" style="max-height: 155px;min-height: 155px">
        <div class="card-body">
